...
const MedicineDetail = () => {
    ...
    const { role, loggedIn } = useSelector((state: any) => state.auth);
    ...
    useEffect(() => {
        const medicine = medicines?.find((medicine: any) => medicine._id === id);
        const medicineInCart = cartItems.find((item: any) => item.item._id === id);
